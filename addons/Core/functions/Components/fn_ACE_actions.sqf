...
//-Clear
_action = ["BCE_Task_Clear",localize "str_disp_arcmap_clear",QPATHTOEF(Core,data\ClearTask.paa),{
	params ["_unit"];
...
_action = ["BCE_Use_Selected_TGP",localize "STR_BCE_AV_Camera",QPATHTOEF(Core,data\AV_Cam.paa),{
		params ["_unit"];
