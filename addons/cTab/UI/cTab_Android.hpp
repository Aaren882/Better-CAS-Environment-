...
{
	x = QUOTE(((((10) + (452)) + ((20) + (((PHONE_MOD) - (20) * 6) / 5)) * (0.35))) / 2048 * PhoneW + CustomPhoneX);
	y = QUOTE(((713) + ((60) - (38)) / 2) / 2048 * CustomPhoneH + CustomPhoneY);
	w = QUOTE(((((PHONE_MOD) - (20) * 6) / 5)) / 2048 * PhoneW);
	h = QUOTE(((40)) / 2048 * CustomPhoneH);
	
	action = "['cTab_Android_dlg'] call cTab_fnc_toggleWeather";
	
	size = QUOTE(0.8 * ((((60) - (20))) / 2048 * CustomPhoneH));
	
	class TextPos
	{
		left = QUOTE(0.25 * (((safezoneW / safezoneH) min 1.2) / 40) / TextTimesH);
		top = QUOTE(0.25 * (((safezoneW / safezoneH) min 1.2) / 40) / TextTimesH);
		right = 0;
		bottom = 0;
	};
...
PHONE_CLASS
{
	...
	class controlsBackground: BCE_Mission_Build_Controls
	{
		...
		class AVmainFrame: cTab_RscFrame
		{
			...
			x = QUOTE(phoneSizeX + (((((452) + (20))) - ((452))) / 2048 * PhoneW));
			y = QUOTE(phoneSizeY + (((((713) + (60) + (10))) - ((713) + (60))) / 2048 * (PhoneW * 4/3)));
			w = QUOTE((((PHONE_MOD) - (20) * 2)) / 2048 * PhoneW);
			h = QUOTE((((626) - (60) - (10) * 2)) / 2048 * (PhoneW * 4/3));
		};
		class AVCamFrame: cTab_RscFrame
		{
			idc = idc_D(4631);
			x = QUOTE(phoneSizeX + (((((((452) + (20)) + (10)) + ((((PHONE_MOD) - (20) * 2) - (10) * 3) / 3) + (10))) - ((452))) / 2048 * PhoneW));
			y = QUOTE(phoneSizeY + (((((((713) + (60) + (10)) + (20)))) - ((713) + (60))) / 2048 * CustomPhoneH));
	...
	class controls
	{
			...
			class Map_Tool_Show: ctrlButton
			{
				...
				x = QUOTE(sizeX + ((((((1341)) - (10) * 8) / 7)) / 2048 * (PhoneW * 3/4)) - (sizeW * (PhoneW * 3/4)));
				Y = QUOTE(sizeY(0) - (sizeW * PhoneW));
				w = QUOTE(sizeW * (PhoneW * 3/4));
				h = QUOTE(sizeW * PhoneW);
			...
			{
				idc = idc_D(1301);
				x = QUOTE((452 / 2048 * PhoneW + CustomPhoneX) + ((PHONE_MOD / 2048 * PhoneW) / 2) - (MARKER_W /2));
				y = QUOTE(Android_BR_InfoY(7));
				w = QUOTE(MARKER_W);
		...
		//- Self Info Box (Bottom Right)
			...
			class CallSign_Box: cTab_RscText_Android
			{
				...
				colorText[] = {0.95,0.95,0.95,1};
				colorBackground[] = {0,0,0,0.3};
				sizeEx = QUOTE(BOX_SIZE_H);
				text = "CallSign : Watt";

				x = QUOTE((((((20) + (452)) + ((20) + (((PHONE_MOD) - (20) * 6) / 5)) * (5 - 1)) + (((PHONE_MOD) - (20) * 6) / 5) - (42)) / 2048 * PhoneW + CustomPhoneX)+ ((42)) / 2048 * PhoneW - ((((PHONE_MOD) - (20) * 6) / 5)) / 2048 * PhoneW);
				y = QUOTE(BOX_POS_Y(3));
				w = QUOTE(((((PHONE_MOD) - (20) * 6) / 5)) / 2048 * PhoneW);
				h = QUOTE(BOX_SIZE_H);
			};
		...
		//- Pages for ATAK
			//- Back Ground
				...
				{
					idc = 4660;
					x = QUOTE(phoneSizeX + (phoneSizeW * 3/5));
					y = QUOTE(phoneSizeY);
			...
			//- Home page of ATAK (Applications)
				...
				{
					idc = idc_D(4660);
					h = QUOTE(phoneSizeH - 0.75 * (((60)) / 2048 * CustomPhoneH));
					class controls{};
				};
		...
		////- Bottons for ATAK Tools
			...
			{
				idc = 46600;
				y = QUOTE(phoneSizeY + phoneSizeH - (0.75 * (((60)) / 2048 * CustomPhoneH)));
				
				// - Check if it's "1erGTD"
				#if PHONE_MOD <= 1134
					h = QUOTE(0.64 * (((60)) / 2048 * CustomPhoneH));
				#else
					h = QUOTE(0.75 * (((60)) / 2048 * CustomPhoneH));
				#endif
				class controls
				{
					class Back: BCE_RscButtonMenu
					{
						...
						size = QUOTE(0.64 * (((60) - (20))) / 2048 * CustomPhoneH);
		...
		//- Map tools 
			#define PhoneMarkerColor \
				x = QUOTE(((((20) + (452)) + ((20) + (((PHONE_MOD) - (20) * 6) / 5)) * (3.8))) / 2048 * PhoneW + CustomPhoneX); \
		...
		// - Weather Condition (Widget)
			...
			{
				x = QUOTE(((((20) + (452)) + ((20) + (((PHONE_MOD) - (20) * 6) / 5)) * (0.35))) / 2048 * PhoneW + CustomPhoneX);
				y = QUOTE((((713)) / 2048  * 	CustomPhoneH + 	CustomPhoneY) + (((60)) / 2048  * CustomPhoneH));
				w = QUOTE(((((PHONE_MOD) - (20) * 6) / 5)) / 2048 * PhoneW);
				
				size = QUOTE(1.15 * (((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) / TextTimesH));
				class Attributes: Attributes
				{
					size = 0.9;
				};
		...
		class Desktop: cTab_RscControlsGroup
		{
			...
			class controls
			{
				class actBFTtxt: ctrlButton
				{
					...
					x = QUOTE((((((257)) + (25)) - ((257))) / 2048 * (PhoneH * 3/4)));
					y = QUOTE((((((491) + (42)) + (25)) - ((491) + (42))) / 2048 * PhoneH));
					w = QUOTE(((100)) / 2048 * (PhoneH * 3/4));
					h = QUOTE(((100)) / 2048 * PhoneH);
